...
<!---Documatic-section-validictory.validator.FieldValidationError-start--->
## [validictory.validator.FieldValidationError](3-validictory_validator.md#validictory.validator.FieldValidationError)

<!---Documatic-section-FieldValidationError-start--->
<!---Documatic-block-validictory.validator.FieldValidationError-start--->
<details>
	<summary><code>validictory.validator.FieldValidationError</code> code snippet</summary>
...
<!---Documatic-block-validictory.validator.FieldValidationError-end--->
<!---Documatic-section-FieldValidationError-end--->

# #
<!---Documatic-section-validictory.validator.FieldValidationError-end--->

<!---Documatic-section-validictory.validator.ValidationError-start--->
## [validictory.validator.ValidationError](3-validictory_validator.md#validictory.validator.ValidationError)

<!---Documatic-section-ValidationError-start--->
<!---Documatic-block-validictory.validator.ValidationError-start--->
<details>
	<summary><code>validictory.validator.ValidationError</code> code snippet</summary>
...
<!---Documatic-section-ValidationError-end--->

# #
<!---Documatic-section-validictory.validator.ValidationError-end--->

<!---Documatic-section-validictory.validator.SchemaValidator-start--->
## [validictory.validator.SchemaValidator](3-validictory_validator.md#validictory.validator.SchemaValidator)

<!---Documatic-section-SchemaValidator-start--->
<!---Documatic-block-validictory.validator.SchemaValidator-start--->
<details>
	<summary><code>validictory.validator.SchemaValidator</code> code snippet</summary>

```python
class SchemaValidator(object):

    def __init__(self, format_validators=None, required_by_default=True, blank_by_default=False, disallow_unknown_properties=False, apply_default_to_data=False, fail_fast=True, remove_unknown_properties=False):
    ...
    def validate_type(self, x, fieldname, schema, path, fieldtype=None):
        ...
        if fieldtype and fieldexists:
            if isinstance(fieldtype, (list, tuple)):
                ...
                if not datavalid:
                    self._error("doesn't match any of {numsubtypes} subtypes in {fieldtype}; errorlist = {errorlist!r}", value, fieldname, path=path, numsubtypes=len(fieldtype), fieldtype=fieldtype, errorlist=errorlist)
                ...
                if not type_checker(value):
                    self._error('is not of type {fieldtype}', value, fieldname, path=path, fieldtype=fieldtype)
            ...
            if isinstance(value, dict):
                if isinstance(properties, dict):
                    if self.disallow_unknown_properties or self.remove_unknown_properties:
                        self._validate_unknown_properties(properties, value, fieldname, schema.get('patternProperties'))
                    for property in properties:
                        self.__validate(property, value, properties.get(property), path + '.' + property)
                else:
                    raise SchemaError("Properties definition of field '{0}' is not an object".format(fieldname))
                ...
                if isinstance(items, (list, tuple)):
                    if 'additionalItems' not in schema and len(items) != len(value):
                        ...
                        for (index, item) in enumerate(items):
                            try:
                                self.__validate('_data', {'_data': value[index]}, item, '{0}[{1}]'.format(path, index))
                            except FieldValidationError as e:
                                raise type(e)("Failed to validate field '%s' list schema: %s" % (fieldname, e), fieldname, e.value)
                elif isinstance(items, dict):
                    for (index, item) in enumerate(value):
                        if (self.disallow_unknown_properties or self.remove_unknown_properties) and 'properties' in items:
                            self._validate_unknown_properties(items['properties'], item, fieldname, schema.get('patternProperties'))
                        self.__validate('[list item]', {'[list item]': item}, items, '{0}[{1}]'.format(path, index))
                else:
                    raise SchemaError("Properties definition of field '{0}' is not a list or an object".format(fieldname))
    ...
    def validate_required(self, x, fieldname, schema, path, required):
        ...
        if fieldname not in x and required:
            self._error("Required field '{fieldname}' is missing", None, path, path=path, exctype=RequiredFieldValidationError)
    ...
    def validate_additionalProperties(self, x, fieldname, schema, path, additionalProperties=None):
        ...
        if isinstance(additionalProperties, (dict, bool)):
            ...
            for eachProperty in value:
                if eachProperty not in properties and (not any((re.match(p, eachProperty) for p in patterns))):
                    if additionalProperties is False:
                        self._error("contains additional property '{prop}' not defined by 'properties' or 'patternProperties' and additionalProperties  is False", value, fieldname, prop=eachProperty, path=path)
                    self.__validate(eachProperty, value, additionalProperties, path)
        else:
            raise SchemaError("additionalProperties schema definition for field '{0}' is not an object".format(fieldname))
            ...
            if isinstance(dependencies, (list, tuple)):
                for dependency in dependencies:
                    if dependency not in x:
                        self._error("Field '{dependency}' is required by field '{fieldname}'", None, fieldname, dependency=dependency, path=path, exctype=DependencyValidationError)
            elif isinstance(dependencies, dict):
                for (k, v) in dependencies.items():
                    if k in x and v not in x:
                        self._error("Field '{k}' is required by field '{v}'", None, fieldname, k=k, v=v, exctype=DependencyValidationError, path=path)
            else:
        ...
        if x.get(fieldname) is not None:
            ...
            if value is not None:
                if type(value) in (int, float) and (not exclusive and value < minimum) or (exclusive and value <= minimum):
                    self._error('is less than minimum value: {minimum}', value, fieldname, minimum=minimum, path=path)
        ...
        if x.get(fieldname) is not None:
            ...
            if value is not None:
                if type(value) in (int, float) and (not exclusive and value > maximum) or (exclusive and value >= maximum):
                    self._error('is greater than maximum value: {maximum}', value, fieldname, maximum=maximum, path=path)
    ...
    def validate_maxProperties(self, x, fieldname, schema, path, number=None):
        ...
        if isinstance(value, dict) and len(value) > number:
            self._error('must have number of properties less than or equal to {number}', value, fieldname, number=number, path=path)
    ...
    def validate_minProperties(self, x, fieldname, schema, path, number=None):
        ...
        value = x.get(fieldname)
        if isinstance(value, dict) and len(value) < number:
            self._error('must have number of properties greater than or equal to {number}', value, fieldname, number=number, path=path)
    ...
    def validate_maxLength(self, x, fieldname, schema, path, length=None):
        ...
        if isinstance(value, (_str_type, list, tuple)) and len(value) > length:
            self._error('must have length less than or equal to {length}', value, fieldname, length=length, path=path)
    ...
    def validate_minLength(self, x, fieldname, schema, path, length=None):
        ...
        value = x.get(fieldname)
        if isinstance(value, (_str_type, list, tuple)) and len(value) < length:
            self._error('must have length greater than or equal to {length}', value, fieldname, length=length, path=path)
    ...
    def validate_pattern(self, x, fieldname, schema, path, pattern=None):
        ...
        if isinstance(value, _str_type) and (isinstance(pattern, _str_type) and (not re.match(pattern, value)) or (not isinstance(pattern, _str_type) and (not pattern.match(value)))):
            self._error("does not match regular expression '{pattern}'", value, fieldname, pattern=pattern, path=path)
    ...
    def validate_enum(self, x, fieldname, schema, path, options=None):
        ...
        if value is not None:
            ...
            if not isinstance(options, Container):
                raise SchemaError("Enumeration {0!r} for field '{1}' must be a container".format(options, fieldname))
            if value not in options:
                if not (value == '' and schema.get('blank', self.blank_by_default)):
                    self._error('is not in the enumeration: {options!r}', value, fieldname, options=options, path=path)
    ...
    def validate_divisibleBy(self, x, fieldname, schema, path, divisibleBy=None):
        ...
        if value % divisibleBy != 0:
            self._error("is not divisible by '{divisibleBy}'.", x.get(fieldname), fieldname, divisibleBy=divisibleBy, path=path)
    ...
    def validate_disallow(self, x, fieldname, schema, path, disallow=None):
        ...
        try:
            ...
            return
        self._error("is disallowed for field '{fieldname}'", x.get(fieldname), fieldname, disallow=disallow, path=path)
    ...
    def __validate(self, fieldname, data, schema, path):
        if schema is not None:
            if not isinstance(schema, dict):
                raise SchemaError("Type for field '%s' must be 'dict', got: '%s'" % (fieldname, type(schema).__name__))
            ...
            if self.apply_default_to_data and 'default' in schema:
                try:
                    self.validate_type(x={'_ds': self.get_default(schema['default'])}, fieldname='_ds', schema=schema, fieldtype=schema['type'] if 'type' in schema else None, path=path)
...
<!---Documatic-section-SchemaValidator-end--->

# #
<!---Documatic-section-validictory.validator.SchemaValidator-end--->

<!---Documatic-section-validictory.validator.MultipleValidationError-start--->
## [validictory.validator.MultipleValidationError](3-validictory_validator.md#validictory.validator.MultipleValidationError)

<!---Documatic-section-MultipleValidationError-start--->
<!---Documatic-block-validictory.validator.MultipleValidationError-start--->
<details>
	<summary><code>validictory.validator.MultipleValidationError</code> code snippet</summary>
...
<!---Documatic-block-validictory.validator.MultipleValidationError-end--->
<!---Documatic-section-MultipleValidationError-end--->

# #
<!---Documatic-section-validictory.validator.MultipleValidationError-end--->

<!---Documatic-section-validictory.validator.SchemaError-start--->
## [validictory.validator.SchemaError](3-validictory_validator.md#validictory.validator.SchemaError)

<!---Documatic-section-SchemaError-start--->
<!---Documatic-block-validictory.validator.SchemaError-start--->
<details>
	<summary><code>validictory.validator.SchemaError</code> code snippet</summary>

```python
class SchemaError(ValueError):
```
</details>
<!---Documatic-block-validictory.validator.SchemaError-end--->
<!---Documatic-section-SchemaError-end--->

# #
<!---Documatic-section-validictory.validator.SchemaError-end--->
